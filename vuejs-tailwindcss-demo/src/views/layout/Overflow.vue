  ...
  <div class="component">
    ...
    >
      <div class="h-32 overflow-hidden">
        <div
          class="overflow-visible h-24 px-6 py-2 rounded-md bg-light-blue-200"
        >
          <p class="md:w-2/3 lg:w-1/2 font-flow leading-5 text-light-blue-700">
            ...
            aliquet elit dui, vitae hendrerit lectus volutpat eget
          </p>
        </div>
      </div>
    </div>
    ...
    <h2>Hidden</h2>
    <div
      class="rounded-t-xl overflow-hidden bg-gradient-to-r from-purple-50 to-purple-100 p-10"
    >
    ...
    <hr />
    <h2>Scroll horizontally if needed</h2>
    <div
    ...
    <hr />
    <h2>Scroll vertically if needed</h2>
    <div
    ...
    <hr />
    <h2>Scroll horizontally always</h2>
    <div
    ...
    <hr />
    <h2>Scroll vertically always</h2>
    <div
      class="rounded-t-xl overflow-hidden bg-gradient-to-r from-light-blue-50 to-light-blue-100 p-10"
    >
    ...
    <hr />
    <h2>Scroll in all directions</h2>
    <div
      class="rounded-t-xl overflow-hidden bg-gradient-to-r from-fuchsia-50 to-fuchsia-100 p-10"
    >
