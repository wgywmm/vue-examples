<template>
  <div class="component">
    ...
    <h2>Static</h2>
    <div
      class="rounded-t-xl overflow-hidden bg-gradient-to-r from-fuchsia-50 to-fuchsia-100 p-10"
    >
      <div class="relative bg-fuchsia-200 p-6">
        <div
          class="static h-32 bg-fuchsia-300 p-4 text-fuchsia-600 font-medium"
        >
          <p>Static parent</p>
          <div
            class="absolute bottom-0 left-0 bg-fuchsia-500 p-4 text-fuchsia-50"
          >
            <p>Absolute child</p>
          </div>
        </div>
    ...
    <h2>Relative</h2>
    <div
      class="rounded-t-xl overflow-hidden bg-gradient-to-r from-rose-50 to-rose-100 p-10"
    >
    ...
    >
      <div
        class="overflow-hidden max-w-md mx-auto mt-4 mb-4 ring-4 ring-amber-300 rounded-xl"
      >
        <div class="rounded-t-xl bg-amber-200 flex px-4 py-3">
          <div class="mr-6">
            <span
              class="inline-block rounded-full bg-amber-400 h-3 w-3 mr-1"
            ></span>
            <span
              class="inline-block rounded-full bg-amber-400 h-3 w-3 mr-1"
            ></span>
        ...
        <div class="relative bg-amber-100 text-amber-600 h-64 font-medium">
          ...
          <div
            class="absolute left-0 right-0 top-0 bg-amber-300 text-amber-700 z-10 px-4 py-3"
          >
            Fixed child
          </div>
          <div
            class="absolute inset-0 overflow-auto pt-16 px-6 pb-4 space-y-4 font-flow"
          >
            ...
            <p>
              ...
              lectus, commodo ac, facilisis ac, ultricies eu, pede. Ut orci
            ...
            <p>
              ...
              lectus. Vivamus consectetuer risus et tortor. Lorem ipsum dolor
            ...
            <p>
              ...
              turpis. Nulla facilisi. Ut fringilla. Suspendisse potenti. Nunc
    ...
    >
      <div class="h-64 overflow-auto">
        <div>
          <div
            class="sticky top-0 bg-emerald-200 px-2 py-1 font-semibold text-emerald-600 rounded-md"
          >
            Sticky Heading 1
          </div>
          <p class="py-4 font-medium text-emerald-500">
            Quisque cursus, metus vitae pharetra auctor, sem massa mattis sem,
            at interdum magna augue eget diam. Vestibulum ante ipsum primis in
            faucibus orci luctus et ultrices posuere cubilia Curae; Morbi
            lacinia molestie dui. Praesent blandit dolor. Sed non quam. In vel
